...
public class Screen {
    ...
    public Rectangle internalFindImage(double timeout, Rectangle area, BufferedImage image, double minSimilarity) throws ImageNotFoundException {
    ...
    public Rectangle internalFindImage(double timeout, Rectangle area, String path, double minSimilarity) throws ImageNotFoundException {
        EventType endEventType = EventType.AFTER_LOCATING;
        BufferedImage bestMatch = null;
        Rectangle matchRect = null;
