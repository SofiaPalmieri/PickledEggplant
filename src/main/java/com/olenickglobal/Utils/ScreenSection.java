...
public class ScreenSection {
    ...
    public void click(double timeout) throws FindFailed, URISyntaxException {
        screen.wait(patternHandler.handlePattern(this.imageName), timeout).getTarget().click();
    }

    public void rightClick(double timeout) throws FindFailed, URISyntaxException {
        screen.wait(patternHandler.handlePattern(this.imageName), timeout).getTarget().rightClick();
    }

    public void doubleClick(double timeout) throws FindFailed, URISyntaxException {
    ...
    public void move(double timeout) throws FindFailed, URISyntaxException {
    ...
    public void executeAction(int timeout, ActionTypeImages type) throws FindFailedHandler, IOException, FindFailed, URISyntaxException {
